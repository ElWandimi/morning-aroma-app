...
export const PRODUCTS = [
  {
    id: "geisha-panama", name: "Geisha", country: "Panama", tier: "premium", priceCents: 5500, stock: 6,
    ...
    growing: "Grown at 1,650–1,900m on volcanic soil in Boquete. Shade-grown under native trees, hand-picked, washed process. Sold as individually-designated micro-lots rather than under a standard grade system, harvested December–April.",
    brewGuide: "Pour-Over", momentMatch: "First Light", course: "Sensory & Cupping",
  },
  {
    id: "laurina-brazil", name: "Laurina", country: "Brazil", tier: "premium", priceCents: 5500, stock: 34,
    ...
    growing: "Grown at 1,100–1,300m in Minas Gerais. Naturally low in caffeine, sun-dried on raised beds. A rare micro-lot varietal — green caffeine content around 0.52% — harvested May–July.",
    brewGuide: "Pour-Over", momentMatch: "The Reset", course: "Sensory & Cupping",
  },
  {
    id: "sl28-kenya", name: "SL28", country: "Kenya", tier: "premium", priceCents: 5250, stock: 3,
    ...
    growing: "Grown at 1,700–2,000m on red volcanic soil in Nyeri. Double-fermented washed process. Graded AA (Kenya's own screen-size classification for the largest beans), harvested on the main October–December crop.",
    brewGuide: "French Press", momentMatch: "The Hustle", course: "Espresso",
  },
  {
    id: "pacamara-elsalvador", name: "Pacamara", country: "El Salvador", tier: "premium", priceCents: 3750, stock: 0,
    ...
    growing: "Grown at 1,300–1,500m in Ahuachapán. Large-bean hybrid, honey processed. Sold as a designated micro-lot, harvested October–April.",
    brewGuide: "French Press", momentMatch: "Comfort", course: "Home Brewing",
  },
  {
    id: "bourbon-rwanda", name: "Bourbon", country: "Rwanda", tier: "everyday", priceCents: 3250, stock: 120,
    ...
    growing: "Grown at 1,700m near Lake Kivu. Fully washed, sun-dried on raised beds. Screen 15+ (Scr. 15+), harvested March–June.",
    brewGuide: "Pour-Over", momentMatch: "First Light", course: "Home Brewing",
  },
  {
    id: "typica-guatemala", name: "Typica", country: "Guatemala", tier: "everyday", priceCents: 3250, stock: 85,
    ...
    growing: "Grown at 1,400–1,600m in Antigua. Volcanic soil, washed process. Graded SHB (Strictly Hard Bean — Guatemala's altitude-based classification for its highest, densest lots), harvested December–April.",
    brewGuide: "Moka Pot", momentMatch: "Comfort", course: "Home Brewing",
  },
  {
    id: "caturra-colombia", name: "Caturra", country: "Colombia", tier: "everyday", priceCents: 3000, stock: 60,
    ...
    growing: "Grown at 1,500–1,800m in Huila. Washed process, dried on patios. Graded Supremo (Colombia's largest screen size), with the main harvest running October–December.",
    brewGuide: "Aeropress", momentMatch: "The Hustle", course: "Home Brewing",
  },
  {
    id: "catuai-honduras", name: "Catuai", country: "Honduras", tier: "everyday", priceCents: 3000, stock: 45,
    ...
    growing: "Grown at 1,200–1,500m in Copán. Washed process, shade-grown. Graded SHG (Strictly High Grown), harvested February–June.",
    brewGuide: "French Press", momentMatch: "The Reset", course: "Home Brewing",
  },
  {
    id: "yirgacheffe-ethiopia", name: "Yirgacheffe", country: "Ethiopia", tier: "premium", priceCents: 4000, stock: 22,
    ...
    growing: "Grown at 1,700–2,200m in the Gedeo Zone near Yirgacheffe town. Many farms are shaded under native forest canopy, hand-picked, fully washed process. Graded 1 (Ethiopia's top cup-quality designation), harvested October–February.",
    brewGuide: "Pour-Over", momentMatch: "First Light", course: "Sensory & Cupping",
  },
  {
    id: "longberry-indonesia", name: "Longberry", country: "Indonesia", tier: "everyday", priceCents: 4250, stock: 55,
  ...
  {
    id: "villa-sarch-costa-rica", name: "Villa Sarchí", country: "Costa Rica", tier: "premium", priceCents: 4000, stock: 28,
    ...
    growing: "Grown at 1,200–1,700m on volcanic loam in Costa Rica's West Valley. Hand-picked from dwarf Bourbon trees and processed at a small, family-run micro-mill using the honey method. Sold as a single-farm micro-lot, harvested December–February in the West Valley.",
    brewGuide: "Pour-Over", momentMatch: "First Light", course: "Sensory & Cupping",
  },
  {
    id: "ngozi-burundi", name: "Ngozi", country: "Burundi", tier: "premium", priceCents: 2750, stock: 30,
    ...
    growing: "Grown at 1,700–2,000m on volcanic clay loam in Burundi's Ngozi province. Hand-picked by smallholder farmers, each with only a few hundred trees, and fully washed at a local washing station. Screen 15+ (Scr. 15+), harvested March–July.",
    brewGuide: "Pour-Over", momentMatch: "The Reset", course: "Sensory & Cupping",
  },
  {
    id: "matari-yemen", name: "Matari", country: "Yemen", tier: "premium", priceCents: 10000, stock: 4,
    ...
    growing: "Grown at 1,800–2,200m on ancient stone terraces in the Bani Matar district of the Haraz mountains. Rain-fed with no irrigation, hand-picked, and naturally dried on rooftops the traditional way. Graded A+, harvested nearly year-round (October–March) due to the region's slow-maturing cherries.",
    brewGuide: "French Press", momentMatch: "Comfort", course: "Sensory & Cupping",
  },
  {
    id: "peaberry-tanzania", name: "Peaberry", country: "Tanzania", tier: "premium", priceCents: 3000, stock: 24,
    ...
    growing: "Grown at 1,400–1,800m on volcanic soil along the southern slopes of Mount Kilimanjaro. Hand-picked and fully washed, then sorted by hand to separate the rounder peaberry beans from the standard flat-bean lots. Graded PB (screen 12+), harvested June–October.",
    brewGuide: "Pour-Over", momentMatch: "The Hustle", course: "Sensory & Cupping",
  },
  {
    id: "chanchamayo-peru", name: "Chanchamayo", country: "Peru", tier: "everyday", priceCents: 3000, stock: 65,
    ...
    growing: "Grown at 1,300–1,700m in the Andean cloud forest of Peru's Chanchamayo valley. Certified organic, shade-grown under native trees, and hand-picked by smallholder cooperative members. Graded 1, harvested March–September.",
...
export const GREEN_BEANS = [
  ...
  },
  {
    ...
    pricePerKgCents: 800, stockKg: 410, minOrderKg: 10,
  ...
  },
  {
    ...
    pricePerKgCents: 1125, stockKg: 350, minOrderKg: 10,
  ...
  },
  {
    ...
    pricePerKgCents: 600, stockKg: 480, minOrderKg: 10,
  ...
  },
  {
    ...
    pricePerKgCents: 650, stockKg: 300, minOrderKg: 10,
  ...
  },
  {
    ...
    pricePerKgCents: 775, stockKg: 160, minOrderKg: 5,
...
export const FAQ_ITEMS = [
  ...
  { q: "I'm not sure which service I need — can I still reach out?", a: "Yes — the inquiry form has a 'Not sure yet' option specifically for that; a short discovery call is how we figure out the right fit.", topic: "services" },
  { q: "How is coffee grading different from the auction representation you offer?", a: "Auction representation is specifically for buying lots at the Nairobi Coffee Exchange. Coffee Grading & Quality Analysis is a standalone service for any lot, from any origin, that you already have in hand or are considering — useful whether or not you ever touch the Kenyan auction.", topic: "services" },
  { q: "Do you sell the equipment you recommend?", a: "No — equipment consulting is deliberately equipment-agnostic. We recommend what fits your budget and volume, not what we'd profit from selling, and we vet suppliers on your behalf rather than acting as one ourselves.", topic: "services" },
  { q: "Can staff training or cupping sessions happen on an ongoing basis, not just once?", a: "Yes — both are available as a one-off session or an ongoing monthly retainer, which is common for cafés with regular staff turnover or roasteries cupping new lots on a schedule.", topic: "services" },
  { q: "Is my data, blend, or roast profile kept confidential?", a: "Yes — anything you share for a consultation, including proprietary blends, roast curves, or supplier contacts, stays confidential and is never shared with other clients.", topic: "services" },
  { q: "What's included in the Academy, and do I pay per course?", a: "Each course is its own monthly subscription, taught by a working barista or roaster with graded chapters and a quiz. If you want everything, a one-time lifetime payment unlocks every course — including ones we add later — instead of subscribing course by course.", topic: "academy" },
  { q: "Do Academy courses give me an actual certificate?", a: "Yes — once you pass a course's chapters and quizzes you can issue a certificate straight from that course page, downloadable as a PDF.", topic: "academy" },
  { q: "How fast do you reply on live chat or WhatsApp?", a: "Our team is online Monday–Friday, 8:00am–5:00pm EAT and usually replies within a few minutes during those hours on either channel. Outside them, your message is saved and we'll get back to you as soon as we're back online.", topic: "contact" },
  { q: "What happens if the site can't load the shop or my order?", a: "If something's genuinely down on our end, you'll see an honest 'couldn't load' message with a Try again button, rather than a blank page or a misleading 'no results' — refreshing after a minute or two almost always clears it.", topic: "shop" },
  { q: "How should I store my beans to keep them fresh?", a: "Keep the bag sealed, away from light and heat, at room temperature — not the fridge or freezer, which introduce moisture and odors. Once opened, an airtight canister keeps beans at their best for about 2–3 weeks; the roast date on the label is your guide.", topic: "shop" },
  { q: "Do you sell ground coffee, or only whole beans?", a: "Every bag ships as whole beans, roasted to order — grinding just before brewing keeps far more aroma and flavor than pre-ground coffee, which starts losing its edge within minutes. Each brew guide lists the right grind size for that method.", topic: "shop" },
];
...
export const SERVICES = [
  {
    ...
    deliverable: "Roast profile notes, a brew recipe card set, and a written action plan after every session.",
    idealFor: "New roasteries, cafés roasting in-house, and teams entering competitions.",
  ...
  },
  {
    ...
    deliverable: "Written tasting notes on every sample cupped, plus a lot recommendation before you commit to a bid.",
    idealFor: "International buyers and importers sourcing from Kenya's weekly auction.",
    fee: "Per-lot commission for remote representation, or a day rate for in-person assistance during your visit.",
  },
  {
    id: "coffee-grading",
    icon: "☕",
    title: "Coffee Grading & Quality Analysis",
    tagline: "Know exactly what's in the bag before you commit to a lot.",
    description:
      "A formal, SCA-aligned assessment of a green coffee lot — defect counts, screen size, moisture, and a full cup score — so you can buy, blend, or reject with confidence instead of a guess.",
    bullets: [
      "Green bean grading against SCA protocols, with primary & secondary defect counts",
      "Screen size classification (AA, AB, PB, SHB, SHG, and other regional grades)",
      "Moisture content and water activity testing",
      "Full cup scoring — fragrance, flavor, aftertaste, acidity, body, balance, sweetness, cleanliness",
      "Origin verification and authenticity assessment",
    ],
    deliverable: "A formal Coffee Grading Report with scores, defect counts, and a clear buy/blend/reject recommendation.",
    idealFor: "Roasteries buying green beans, importers verifying lots, cafés selecting a house blend, and competitors prepping for cup competitions.",
    fee: "Per sample, scaled to the depth of testing requested — bulk packages available for 10+ samples. Quoted after a short discovery call.",
  },
  {
    id: "roast-profile-development",
    icon: "🔥",
    title: "Roast Profile Development",
    tagline: "A profile built for your beans, your roaster, and your cup — not a generic curve.",
    description:
      "Beyond the troubleshooting covered in remote consulting above, this is ground-up roast curve development for a specific origin or variety — charge temp, development time, drop temp, and rate-of-rise, tuned for filter, espresso, or an omni-roast that works for both.",
    bullets: [
      "Custom roast curve development per origin or variety",
      "Roast defect diagnosis — baked, underdeveloped, scorched, or tipped batches",
      "Optimization for filter, espresso, or omni-roast use",
      "Profile files formatted for common roast-logging software, for your team to replicate",
    ],
    deliverable: "Roast curve graphs, sensory notes at each development stage, and step-by-step roasting instructions with a recommended resting time before packaging.",
    idealFor: "New roasteries, cafés roasting in-house, and roasters entering competitions.",
    fee: "Per profile, or a discounted rate for a full origin portfolio of five or more. Quoted after a short discovery call.",
  },
  {
    id: "cupping-sessions",
    icon: "🧪",
    title: "Sensory Evaluation & Cupping Sessions",
    tagline: "Put your lots, blends, or roast levels side by side and taste the difference.",
    description:
      "A live, guided cupping session — blind or open — comparing the coffees that matter to your business right now, with staff training on SCA cupping protocol built in.",
    bullets: [
      "Blind or open cupping sessions comparing lots, blends, or roast levels",
      "SCA cupping protocol training for your staff",
      "Flavor attribute identification — aroma, acidity, body, sweetness, balance",
      "Flavor wheel mapping ready to drop into menu descriptions",
    ],
    deliverable: "Cupping score sheets, a flavor profile summary, and menu-ready tasting notes.",
    idealFor: "Cafés building menu descriptions, roasteries selecting lots, and baristas preparing for competitions.",
    fee: "Half-day or full-day sessions, or a monthly retainer for ongoing staff training. Quoted after a short discovery call.",
  },
  {
    id: "equipment-consulting",
    icon: "⚙️",
    title: "Equipment Consulting",
    tagline: "The right machine for your budget and volume — not whatever we'd rather sell you.",
    description:
      "Equipment-agnostic advice on roasters, grinders, brewers, espresso machines, and packaging line equipment, matched to your real budget and throughput — for a commercial buildout or a home setup you're upgrading.",
    bullets: [
      "Roaster, grinder, brewer, and espresso machine recommendations matched to budget and volume",
      "Supplier sourcing and vetting",
      "Packaging-line equipment guidance — destoners, weigh-fill machines, VFFS systems",
      "Home setup consulting for pour-over, espresso, or manual brewing upgrades",
    ],
    deliverable: "An equipment comparison spreadsheet, a rough ROI analysis, a supplier shortlist with pricing, and installation/workflow recommendations.",
    idealFor: "Café startups, new roasteries, home enthusiasts upgrading their setup, and businesses scaling production.",
    fee: "Home setup consults are the lightest tier; commercial setups and full roastery design scale with scope. Quoted after a short discovery call.",
  },
  {
    id: "menu-development",
    icon: "📋",
    title: "Café Menu & Brew Method Development",
    tagline: "A menu that matches each coffee to the method that shows it off.",
    description:
      "Brew menu design — filter, espresso, and signature drinks — with each coffee matched to its best brew method, plus recipe cards and barista training so the menu holds up on a busy shift.",
    bullets: [
      "Brew menu design across filter, espresso, and signature drinks",
      "Matching each coffee to its best brew method",
      "Recipe cards specifying dose, yield, time, and temperature",
      "Barista training for consistency and workflow under pressure",
      "Seasonal offerings and signature drink development",
    ],
    deliverable: "A menu layout with tasting notes, a full set of brew recipe cards, and a barista training manual.",
    idealFor: "New cafés, existing cafés refreshing a menu, and bars adding a specialty coffee program.",
    fee: "Menu development and barista training are quoted separately, or bundled as a full program. Quoted after a short discovery call.",
  },
  {
    id: "packaging-consulting",
    icon: "📦",
    title: "Packaging & Shelf-Life Consultation",
    tagline: "The bag matters as much as the roast — get it right before you scale.",
    description:
      "Packaging format, barrier film, and degassing valve recommendations paired with real shelf-life guidance, so what's in the bag still tastes like what you roasted by the time it reaches a shelf.",
    bullets: [
      "Packaging format recommendations — bags, capsules, or frac packs",
      "Degassing valve, barrier film, and seal integrity guidance",
      "Shelf-life testing and storage recommendations",
      "Labeling compliance review — origin, roast date, tasting notes",
      "Equipment selection for a packaging line",
    ],
    deliverable: "A packaging specification sheet, supplier recommendations, a shelf-life report, and a labeling template.",
    idealFor: "Roasteries scaling production, brands launching a retail product, and private label clients.",
    fee: "A standalone consultation, or a full packaging line design for larger builds. Quoted after a short discovery call.",
  },
  {
    id: "barista-training",
    icon: "🎓",
    title: "Barista & Staff Training",
    tagline: "Faster, more consistent baristas — trained on your own bar.",
    description:
      "Hands-on training on espresso extraction, milk steaming, and pour-over technique, plus sensory skills and grinder/recipe calibration — built for a team that needs to get faster and more consistent, not just talented.",
    bullets: [
      "Espresso extraction, milk steaming, and pour-over technique",
      "Sensory skills and cupping fundamentals",
      "Grinder calibration and recipe dial-in",
      "Consistency and speed coaching for a busy bar",
      "Competition preparation for staff entering barista competitions",
    ],
    deliverable: "A training curriculum, practical assessments, a certificate of completion, and follow-up support.",
    idealFor: "Cafés with high staff turnover, bars entering competitions, and new hires who need to get up to speed fast.",
    fee: "Per-day training, or an ongoing monthly retainer. Quoted after a short discovery call.",
  },
  {
    id: "sourcing-consulting",
    icon: "📊",
    title: "Business & Sourcing Consultation",
    tagline: "Real supplier contacts and a sourcing strategy — not just theory.",
    description:
      "Beyond representation at the Nairobi auction above, this covers sourcing from any origin — building a strategy across single origin, blends, and micro-lots, with real supplier contacts, contract negotiation support, and certification guidance.",
    bullets: [
      "Green bean sourcing from reliable importers and farms, any origin",
      "Pricing and contract negotiation support",
      "Sourcing strategy across single origin, blends, and micro-lots",
      "Certification guidance — Organic, Fairtrade, Rainforest Alliance",
      "Cost analysis and retail/wholesale pricing strategy",
    ],
    deliverable: "A sourcing roadmap, real supplier contacts, a cost & margin analysis, and certification guidance.",
    idealFor: "New roasteries, cafés expanding their offering, and importers or exporters.",
    fee: "Consultation, or a full sourcing strategy engagement. Quoted after a short discovery call.",
  },
];

export const WHO_WE_WORK_WITH = [
  { icon: "🏭", type: "New Roasteries", needs: "Grading, roast profile development, equipment consulting, and packaging" },
  { icon: "☕", type: "Established Cafés", needs: "Menu development, staff training, and ongoing quality control" },
  { icon: "🧑‍🍳", type: "Baristas", needs: "Sensory training, competition prep, and grinder/recipe dial-in" },
  { icon: "🚀", type: "Coffee Startups", needs: "Sourcing strategy, business planning, and equipment selection" },
  { icon: "🏠", type: "Home Enthusiasts", needs: "Equipment advice, brew method guidance, and bean selection" },
  { icon: "🌍", type: "Importers & Exporters", needs: "Grading, quality verification, and market positioning" },
];
...
export const PAGE_META = {
  ...
  brewguides: { title: "Coffee Brew Guides — Pour-Over & Espresso — Morning Aroma", description: "Step-by-step guides for pour-over, French press, espresso, cold brew, moka pot, and Aeropress." },
  academy: { title: "Coffee Academy — Brewing & Roasting Courses — Morning Aroma", description: "Learn to make espresso, cappuccino, latte, and more — courses taught by working baristas and roasters." },
  ...
  promise: { title: "Our Promise — Traceable, Fair-Priced Coffee — Morning Aroma", description: "Our vision, mission, and the core values we hold ourselves to — traceability, fair pricing, and craft over speed." },
  ...
  quiz: { title: "Aroma Quiz — Find Your Coffee Match — Morning Aroma", description: "Answer four quick questions and we'll match you to a variety." },
  rituals: { title: "Global Coffee Rituals & Ceremonies — Morning Aroma", description: "Coffee ceremonies from around the world — Ethiopian Bunna, Turkish Kahve, Italian espresso culture, and more." },
  faq: { title: "Frequently Asked Questions — Morning Aroma", description: "Answers to common questions about freshness, shipping, subscriptions, and wholesale." },
  contact: { title: "Contact Morning Aroma — Get in Touch", description: "Get in touch with the Morning Aroma team." },
  careers: { title: "Careers at Morning Aroma — Join Our Team", description: "We're a small, global team of coffee people. No open roles right now — but we'd genuinely like to hear from you." },
  blog: { title: "Journal — Coffee Stories & Sourcing — Morning Aroma", description: "Real stories on sourcing, brewing, and the people behind every bag." },
  ...
  services: { title: "Roasting & Brewing Consulting Services — Morning Aroma", description: "Remote roasting and brewing consulting, plus Kenyan coffee auction representation, for businesses." },
...
// Real E.164 dial codes and correctly-derived flag emojis for every ISO 3166-1 country --
// used by the checkout shipping form's country and phone-country-code selectors. Country
// display NAMES are derived at render time via Intl.DisplayNames (a real, built-in browser
// API), not stored here, since it's a solved, standards-based lookup rather than something
// worth hand-maintaining or fetching from a third-party API.
